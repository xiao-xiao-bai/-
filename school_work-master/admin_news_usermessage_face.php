...
$sql =<<<SQL
SELECT user_name,COUNT(user_name) counts FROM newcomment
GROUP BY user_name
SQL;
...
$array_2 = [];//存储用户留言数
$i = 0;
foreach ($infors as $vale){
    $array_1[$i] = $vale['user_name'];
...
<div style="background-image: url(image/userinfor.jpg)">
    <div>
        <!--检索留言人即post方法-->
        <form action="admin_news_usermessage_search.php" method="post">
